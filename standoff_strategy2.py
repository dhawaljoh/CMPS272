...
def get_action_from_player_strategy1(player1, player2):
...
def get_action_from_player_strategy2(player1, player2):
	if player1.null and player2.null:
		# player1.reload()
		return 1
	if player1.null and player2.bullet1:
...
def get_action_from_player_strategy3(player1, player2):
	if player1.null and player2.null:
		# player1.reload()
		return 1
	if player1.null and player2.bullet1:
...
def get_action_from_player_strategy4(player1, player2):
	if player1.null and player2.null:
		# player1.reload()
		return 1
	if player1.null and player2.bullet1:
...
def get_action_from_player_strategy5(player1, player2):
	if player1.null and player2.null:
		# player1.reload()
		return 1
	if player1.null and player2.bullet1:
...
def get_action_from_player_strategy6(player1, player2):
	if player1.null and player2.null:
		# player1.reload()
		return 1
	if player1.null and player2.bullet1:
...
def main():
	...
	while not gameOver:
		...
		if not p1.dead and not p2.dead:
			...
			if playerTurn[i] == 1:
				choice = get_action_from_player_strategy2(p1,p2)
			else:
			# ///////////////////////
			# (p2,p1) now because you're playing wrt p2
				choice = get_action_from_player_strategy6(p2,p1)
			# ///////////////////////
